...
- `vieza generate`: write generated files.
...
- `generated/vieza.yml`: vivid theme with eza-like styles.
- `generated/vieza-filetypes.yml`: eza-derived vivid filetype additions only.
- `generated/filetypes.yml`: vivid default database plus eza-derived additions.
